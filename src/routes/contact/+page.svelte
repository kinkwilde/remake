<div class="my-12 flex w-full items-center justify-center">
    <div class="top-40 rounded bg-black py-16 px-8 lg:px-28">
        <p class="text-center text-xl font-bold leading-7 text-black md:text-3xl">
        ...
        <div class="flex w-full items-center justify-center">
            <button
                class="mt-9 rounded bg-accent2 py-4 px-10 text-base font-semi leading-none text-black hover:bg-accent2 focus:outline-none focus:ring-2 focus:ring-accent2 focus:ring-offset-2"
                >SUBMIT</button
            >
        </div>
    </div>
