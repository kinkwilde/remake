...
<div class="bg-gray-900 px-6 py-9">
    <div class="container">
        <div class="grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-8 lg:grid-cols-3 xl:grid-cols-4">
            <div class="flex flex-shrink-0 flex-col">
                <Logo textSize="text-4xl" />
                <p class="mt-2 mb-4 text-sm leading-none text-gray-800 dark:text-white">
                    Copyright &copy; 2020 - {copyrightDate}
                </p>
            ...
            <div class="ml-8 flex flex-col sm:ml-0">
                ...
                <a
                    href="/"
                    class="mt-6 cursor-pointer text-base leading-4 text-gray-800 hover:text-gray-500 focus:underline focus:outline-none dark:text-white"
                    >Blog</a
                >
                <a
                    href="/"
            ...
            <div class="mt-10 hidden lg:block">
                <div
                    class="mt-4 flex cursor-pointer items-center justify-between border border-gray-800 dark:border-white"
                >
                    <input
                        type="text"
                        class="w-full p-4 text-base leading-4 text-gray-800 placeholder-gray-800 focus:outline-none dark:border-white dark:bg-gray-900 dark:text-white dark:placeholder-white"
        ...
        <div class="mt-10 lg:hidden">
            <div
                class="mt-4 flex items-center justify-between border border-gray-800 dark:border-white"
            >
                <input
                    type="text"
                    class="relative z-0 w-full p-4 text-base leading-4 text-gray-800 placeholder-gray-800 focus:outline-none dark:border-white dark:bg-gray-900 dark:text-white dark:placeholder-white"
                    placeholder="Enter your email"
                />
                <button
                    aria-label="send"
